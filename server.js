...
app.put('/api/users/:id', authMiddleware, adminOnly, async (req, res) => {
  const { name, role, phone, color, status, can_view_all_jobs, can_edit_jobs, can_view_finance, default_commission_type, default_commission_value, commission_rules, use_masking, qualified_job_types, is_enabled } = req.body;
