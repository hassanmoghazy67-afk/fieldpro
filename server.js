...
// Login-specific limiter — much stricter than the general API limit, since
// login is the one route where "many fast attempts" usually means someone is
// actively trying to guess a password, not normal app usage. 10 attempts per
// 15 minutes per IP is generous enough for a real person who mistyped their
// password a few times, but genuinely throttles automated brute-forcing.
